...
class A {
  constructor({ selector = null, minChars = 1, delay = 150, offsetLeft = 0, offsetTop = 1 }) {
  ...
  connectedCallback() {
    if (this.input.hasAttribute('placeholder')) this.input.placeholder = this.input.getAttribute('placeholder')
    if (this.input.hasAttribute('name')) this.input.name = this.input.getAttribute('name')
  }
